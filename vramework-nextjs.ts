...
/**
* This file was generated by @vramework/cli@0.5.33
*/
...
import type { HTTPMethod } from '@vramework/core/http/http-routes.types'
import type { RoutesMap, RouteHandlerOf } from './backend/.vramework/vramework-routes-map.d'

import { getConfig as createConfig } from './backend/config'
import { createSingletonServices as createSingletonServices } from './backend/services'
import { createSessionServices as createSessionServices } from './backend/services'

import './backend/.vramework/vramework-routes'
import './backend/.vramework/vramework-schemas/register'
